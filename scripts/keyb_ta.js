...
function updatekeyboard(val, keyclass)
{
	...
	document.getElementById('1').value=val+'\u0BBE';
	document.getElementById('2').value=val+'\u0BBF';
	document.getElementById('3').value=val+'\u0BC0';
	document.getElementById('4').value=val+'\u0BC1';
	document.getElementById('5').value=val+'\u0BC2';
	document.getElementById('6').value=val+'\u0BC6';
	document.getElementById('7').value=val+'\u0BC7';
	document.getElementById('8').value=val+'\u0BC8';
	document.getElementById('9').value=val+'\u0BCA';
	document.getElementById('10').value=val+'\u0BCB';
	document.getElementById('11').value=val+'\u0BCC';
